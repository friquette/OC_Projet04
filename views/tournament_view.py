...
class TournamentView:
    ...
    def display_tournament_creation(self):
        ...
        preset_players = ["b03017d2-a3a1-406c-af08-88d0be93e356", "11dc9bec-3d10-4312-982f-754a26b475a2",
        ...
        for p_player in preset_players:
            id_user = player_manager.find_player_by_id(p_player)
            players.append(id_user)
            new_player_list.append([id_user, .0])
